...
knitr::opts_chunk$set(
  ...
  # fig.width = 7,      # Width of plots
  # fig.height = 5,      # Height of plots
)
knitr::opts_knit$set(root.dir = "/scratch/csierra/multiome_osk")
```

```{r packages, echo=FALSE, include = FALSE}
lapply(c("Signac", "irlba", "ggplot2","Seurat", "SingleR", "readxl",
         "dplyr", "ggrepel", "writexl", "SeuratWrappers", "Rmisc", "FSA", "ccAFv2"),
...
exc_CON_GFP<-subset(exc, Group=="CON_GFP")
exc_AD_OSK<-subset(exc, Group=="AD_OSK")
exc_AD_GFP<-subset(exc, Group=="AD_GFP")
...
# Is there any loss of identity?
```{r Load object and subset infected Pos, include = FALSE}
#Subset infected
merged_all_inf<-subset(merged_all, infected=="Pos")
```

```{r cell cycle markers in infected cells}
# Visualize the distribution of cell cycle markers across
RidgePlot(merged_all_inf, features = c("Pcna", "Top2a", "Mcm6", "Mki67"), ncol = 2)
#ggsave("/scratch/csierra/multiome_osk/plots/3_RNA_cellcyclemarkers.pdf", height = 5, width = 5, dpi=300)
RidgePlot(merged_all_inf, features = c("Rbfox3"), ncol = 2)
#ggsave("/scratch/csierra/multiome_osk/plots/3_RNA_Rbfox3.pdf", height = 3.5, width = 5, dpi=300)
```
